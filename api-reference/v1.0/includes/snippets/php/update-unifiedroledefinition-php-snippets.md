...
$rolePermissions1 = new UnifiedRolePermission();$rolePermissions1AdditionalData = [
...
$requestRequestBody->setRolePermissions($rolePermissionsArray);
 $graphClient->roleManagement()->directory()->roleDefinitionsById('unifiedRoleDefinition-id')->patch($requestRequestBody);
