...
$values1 = new SettingValue();$values1AdditionalData = [
...
$values2 = new SettingValue();$values2AdditionalData = [
...
$values3 = new SettingValue();$values3AdditionalData = [
...
$values4 = new SettingValue();$values4AdditionalData = [
