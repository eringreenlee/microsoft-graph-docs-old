...
$requestRequestBody = new BatchRecordDecisionsRequestBody();
...
$requestRequestBody->setResourceId('a5c51e59-3fcd-4a37-87a1-835c0c21488a');
 $graphClient->identityGovernance()->accessReviews()->definitionsById('accessReviewScheduleDefinition-id')->instancesById('accessReviewInstance-id')->batchRecordDecisions()->post($requestRequestBody);
