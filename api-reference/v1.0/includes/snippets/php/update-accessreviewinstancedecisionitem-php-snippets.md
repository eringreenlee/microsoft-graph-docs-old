...
$requestRequestBody->setJustification('Kathleen still needs access to the Marketing group as she works in the Marketing organization.');
 $graphClient->identityGovernance()->accessReviews()->definitionsById('accessReviewScheduleDefinition-id')->instancesById('accessReviewInstance-id')->decisionsById('accessReviewInstanceDecisionItem-id')->patch($requestRequestBody);
