...
$policyViolation->setVerdictDetails('AllowOverrideWithoutJustification,AllowFalsePositiveOverride');
$policyViolation->setDlpAction('BlockAccess');

 $graphClient->teamsById('team-id')->channelsById('channel-id')->messagesById('chatMessage-id')->patch($requestRequestBody);
