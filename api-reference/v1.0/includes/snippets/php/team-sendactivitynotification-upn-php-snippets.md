...
$templateParameters1 = new KeyValuePair();$templateParameters1->setName("reservationId");
$templateParameters1->setValue("TREEE433");

$templateParametersArray []= $templateParameters1;

$templateParameters2 = new KeyValuePair();$templateParameters2->setName("currentSlot");
...
$requestRequestBody->setTemplateParameters($templateParametersArray);
 $graphClient->teamsById("team-id")->sendActivityNotification()->post($requestRequestBody);
