...
$requestRequestBody = new FindMeetingTimesRequestBody();

$attendeesArray = [];

$attendees1 = new AttendeeBase();$attendees1AdditionalData = [
			"type" => "required",
	];
...
$locations1 = new LocationConstraintItem();$locations1AdditionalData = [
...
$timeConstraint->setActivityDomain("work");
$timeSlotsArray = [];
