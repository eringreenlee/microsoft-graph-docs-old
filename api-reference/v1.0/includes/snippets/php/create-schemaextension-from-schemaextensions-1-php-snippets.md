...
$properties1 = new ExtensionSchemaProperty();$properties1AdditionalData = [
			"name" => "courseId",
			"type" => "Integer",
	];
...
$properties2 = new ExtensionSchemaProperty();$properties2AdditionalData = [
		"name" => "courseName",
		"type" => "String",
];
...
$properties3 = new ExtensionSchemaProperty();$properties3AdditionalData = [
	"name" => "courseType",
	"type" => "String",
];
