...
$requestRequestBody->setVisibility("Private");
...
$channels1 = new Channel();$channels1->setDisplayName("Announcements 📢");
...
$channels2 = new Channel();$channels2->setDisplayName("Training 🏋️");
...
$tabs1 = new TeamsTab();$tabs1->setDisplayName("A Pinned Website");
...
$tabs2 = new TeamsTab();$tabs2->setDisplayName("A Pinned YouTube Video");
...
$channels3 = new Channel();$channels3->setDisplayName("Planning 📅 ");
...
$channels4 = new Channel();$channels4->setDisplayName("Issues and Feedback 🐞");
...
$funSettings->setGiphyContentRating("Moderate");
...
$installedApps1 = new TeamsAppInstallation();$installedApps1AdditionalData = [
...
$installedApps2 = new TeamsAppInstallation();$installedApps2AdditionalData = [
