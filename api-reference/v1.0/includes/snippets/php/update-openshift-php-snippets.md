...
$sharedOpenShift->setTheme("white");
$activitiesArray = [];

$activities1 = new ShiftActivity();$activities1->setIsPaid(True);
...
$requestRequestBody->setDraftOpenShift(null);
 $graphClient->teamsById("team-id")->schedule()->openShiftsById("openShift-id")->patch($requestRequestBody);
