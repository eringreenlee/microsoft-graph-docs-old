...
$operationsArray = [];
'All',$operationsArray []= $operations1;
$target->setOperations($operationsArray);
...
$requestRequestBody->setAdditionalData($requestRequestBodyAdditionalData);
 $graphClient->policies()->roleManagementPoliciesById('unifiedRoleManagementPolicy-id')->rulesById('unifiedRoleManagementPolicyRule-id')->patch($requestRequestBody);
