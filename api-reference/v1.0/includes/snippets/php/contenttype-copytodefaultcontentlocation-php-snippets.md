...
$requestRequestBody = new CopyToDefaultContentLocationRequestBody();
...
$requestRequestBody->setDestinationFileName('newname.txt');
 $graphClient->sitesById('site-id')->contentTypesById('contentType-id')->copyToDefaultContentLocation()->post($requestRequestBody);
