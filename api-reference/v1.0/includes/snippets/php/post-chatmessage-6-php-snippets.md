...
$attachments1->setContentType('application/vnd.microsoft.card.adaptive');
...
$hostedContents1 = new ChatMessageHostedContent();

$hostedContents1AdditionalData = [
...
$hostedContents1->setAdditionalData($hostedContents1AdditionalData);

$hostedContentsArray []= $hostedContents1;

$hostedContents2 = new ChatMessageHostedContent();

$hostedContents2AdditionalData = [
...
$hostedContents2->setAdditionalData($hostedContents2AdditionalData);

$hostedContentsArray []= $hostedContents2;
$requestRequestBody->setHostedContents($hostedContentsArray);
