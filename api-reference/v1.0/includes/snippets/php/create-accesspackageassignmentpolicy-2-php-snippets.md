...
$requestRequestBody->setAllowedTargetScope("allConfiguredConnectedOrganizationUsers");
...
$stages1 = new AccessPackageApprovalStage();$stages1->setDurationBeforeAutomaticDenial("P14D");
...
$primaryApprovers1 = new SubjectSet();$primaryApprovers1AdditionalData = [
...
$fallbackPrimaryApprovers1 = new SubjectSet();$fallbackPrimaryApprovers1AdditionalData = [
...
$fallbackPrimaryApprovers2 = new SubjectSet();$fallbackPrimaryApprovers2AdditionalData = [
...
$stages2 = new AccessPackageApprovalStage();$stages2->setDurationBeforeAutomaticDenial("P14D");
...
$reviewSettings->setExpirationBehavior("keepAccess");
...
$primaryReviewers1 = new SubjectSet();$primaryReviewers1AdditionalData = [
"@odata.type" => "#microsoft.graph.groupMembers",
"groupId" => "1623f912-5e86-41c2-af47-39dd67582b66",
];
