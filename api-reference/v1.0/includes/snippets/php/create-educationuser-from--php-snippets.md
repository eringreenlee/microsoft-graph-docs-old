...
$requestRequestBody->setPrimaryRole('String');
$requestRequestBody->setMiddleName('String');
$requestRequestBody->setExternalSource('String');
...
$assignedLicenses1 = new AssignedLicense();$assignedLicenses1AdditionalData = [
...
$assignedPlans1 = new AssignedPlan();$assignedPlans1AdditionalData = [
...
$provisionedPlans1 = new ProvisionedPlan();$provisionedPlans1AdditionalData = [
