...
$annotations1 = new ProfileCardAnnotation();$annotations1->setDisplayName('Cost Center');
$localizationsArray = [];

$localizations1 = new DisplayNameLocalization();$localizations1->setLanguageTag('ru-RU');
