...
$relatedContacts1 = new RelatedContact();$relatedContacts1->setDisplayName('Father Time');
...
$relatedContacts2 = new RelatedContact();$relatedContacts2->setDisplayName('Mother Nature');
