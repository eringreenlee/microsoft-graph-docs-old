...
$addresses1 = new PhysicalAddress();$addresses1->setPostOfficeBox('');
...
$addresses2 = new PhysicalAddress();$addresses2->setPostOfficeBox('');
...
$phones1 = new Phone();$phones1->setNumber('206-555-0100');
$phones1->setType('home');

$phonesArray []= $phones1;

$phones2 = new Phone();$phones2->setNumber('206-555-0200');
