...
$requestRequestBody->setImageType('custom');
...
$requestRequestBody->setAdditionalData($requestRequestBodyAdditionalData);
 $graphClient->deviceManagement()->virtualEndpoint()->provisioningPoliciesById('cloudPcProvisioningPolicy-id')->patch($requestRequestBody);
