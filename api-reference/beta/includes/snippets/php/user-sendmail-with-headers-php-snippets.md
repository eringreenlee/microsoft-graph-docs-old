...
$internetMessageHeaders1 = new InternetMessageHeader();$internetMessageHeaders1->setName("x-custom-header-group-name");
$internetMessageHeaders1->setValue("Nevada");

$internetMessageHeadersArray []= $internetMessageHeaders1;

$internetMessageHeaders2 = new InternetMessageHeader();$internetMessageHeaders2->setName("x-custom-header-group-id");
