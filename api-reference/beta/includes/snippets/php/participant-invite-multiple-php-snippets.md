...
$participants2 = new InvitationParticipantInfo();$participants2AdditionalData = [
	"@odata.type" => '#microsoft.graph.invitationParticipantInfo',
	"replacesCallId" => 'a7ebfb2d-871e-419c-87af-27290b22e8db',
];
$participants2->setAdditionalData($participants2AdditionalData);

$participantsArray []= $participants2;
