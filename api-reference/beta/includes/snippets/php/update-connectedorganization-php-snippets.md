...
$requestRequestBody->setState('configured');
 $graphClient->identityGovernance()->entitlementManagement()->connectedOrganizationsById('connectedOrganization-id')->patch($requestRequestBody);
