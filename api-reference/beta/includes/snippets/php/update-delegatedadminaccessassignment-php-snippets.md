...
$requestConfiguration->headers = $headers;
 ...
 $graphClient->tenantRelationships()->delegatedAdminRelationshipsById("delegatedAdminRelationship-id")->accessAssignmentsById("delegatedAdminAccessAssignment-id")->patch($requestRequestBody, $requestConfiguration);
