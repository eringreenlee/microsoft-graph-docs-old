...
$allowedValues1 = new AllowedValue();$allowedValues1->setId('Alpine');
$allowedValues1->setIsActive(True);

$allowedValuesArray []= $allowedValues1;

$allowedValues2 = new AllowedValue();$allowedValues2->setId('Baker');
$allowedValues2->setIsActive(True);

$allowedValuesArray []= $allowedValues2;

$allowedValues3 = new AllowedValue();$allowedValues3->setId('Cascade');
