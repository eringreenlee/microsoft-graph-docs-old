...
$instructions->setContentType('text');
...
$requestRequestBody->setAddedStudentAction('none');
$requestRequestBody->setAddToCalendarAction('studentsAndPublisher');
 $graphClient->education()->classesById('educationClass-id')->assignmentsById('educationAssignment-id')->patch($requestRequestBody);
