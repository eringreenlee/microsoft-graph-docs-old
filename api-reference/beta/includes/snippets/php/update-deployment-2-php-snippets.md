...
$monitoringRules1 = new MonitoringRule();$monitoringRules1->setSignal("rollback");
$monitoringRules1->setThreshold(5);
$monitoringRules1->setAction("pauseDeployment");
...
$requestRequestBody->setAdditionalData($requestRequestBodyAdditionalData);
 $graphClient->admin()->windows()->updates()->deploymentsById("deployment-id")->patch($requestRequestBody);
