...
$requestRequestBody = new TentativelyAcceptRequestBody();

$requestRequestBody->setComment('I may not be able to make this week. How about next week?');
...
$end->setTimeZone('Pacific Standard Time');
 ...
 $graphClient->me()->eventsById('event-id')->tentativelyAccept()->post($requestRequestBody);
