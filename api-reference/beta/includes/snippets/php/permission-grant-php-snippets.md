...
$requestRequestBody = new GrantRequestBody();

$recipientsArray = [];

$recipients1 = new DriveRecipient();$recipients1->setEmail("john@contoso.com");

$recipientsArray []= $recipients1;

$recipients2 = new DriveRecipient();$recipients2->setEmail("ryan@external.com");
