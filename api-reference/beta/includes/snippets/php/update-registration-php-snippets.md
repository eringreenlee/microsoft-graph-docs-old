...
$speakers1 = new MeetingSpeaker();$speakers1->setDisplayName("Henry Ross");
$speakers1->setBio("Chairman and Chief Executive Officer");

$speakersArray []= $speakers1;

$speakers2 = new MeetingSpeaker();$speakers2->setDisplayName("Fred Ryan");
$speakers2->setBio("CVP");

$speakersArray []= $speakers2;
$requestRequestBody->setSpeakers($speakersArray);
 $graphClient->me()->onlineMeetingsById("onlineMeeting-id")->registration()->patch($requestRequestBody);
