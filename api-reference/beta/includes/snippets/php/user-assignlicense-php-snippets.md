...
$requestRequestBody = new AssignLicenseRequestBody();

$addLicensesArray = [];

$addLicenses1 = new AssignedLicense();$addLicenses1AdditionalData = [
		"disabledPlans" =>  [
...
$addLicenses2 = new AssignedLicense();$addLicenses2AdditionalData = [
	"disabledPlans" =>  [
	],
