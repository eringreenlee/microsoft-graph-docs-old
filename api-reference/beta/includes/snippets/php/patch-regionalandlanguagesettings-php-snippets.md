...
$authoringLanguages1 = new LocaleInfo();$authoringLanguages1->setLocale('en-US');

$authoringLanguagesArray []= $authoringLanguages1;

$authoringLanguages2 = new LocaleInfo();$authoringLanguages2->setLocale('es-MX');
...
$defaultRegionalFormat->setLocale('en-US');
 ...
 $graphClient->me()->settings()->regionalAndLanguageSettings()->patch($requestRequestBody);
