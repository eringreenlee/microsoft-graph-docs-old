...
$approvalStages1 = new ApprovalStage();$approvalStages1->setApprovalStageTimeOutInDays(14);
...
$primaryApprovers1 = new UserSet();$primaryApprovers1->setIsBackup(True);
...
$primaryApprovers2 = new UserSet();$primaryApprovers2->setIsBackup(False);
...
$questions1 = new AccessPackageQuestion();$questions1->setIsRequired(False);
...
$localizedTexts1 = new AccessPackageLocalizedText();$localizedTexts1->setText("¿De qué estado eres?");
...
$questions2 = new AccessPackageQuestion();$questions2->setIsRequired(False);
...
$localizedTexts1 = new AccessPackageLocalizedText();$localizedTexts1->setText("por qué necesita acceso a este paquete");
$localizedTexts1->setLanguageCode("es");
