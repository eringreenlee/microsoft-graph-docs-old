...
$requestRequestBody->setRoutingMode('oneToOne');
...
'550fae72-d251-43ec-868c-373732c2704f','72f988bf-86f1-41af-91ab-2d7cd011db47',],
 $graphClient->communications()->callsById('call-id')->audioRoutingGroupsById('audioRoutingGroup-id')->patch($requestRequestBody);
