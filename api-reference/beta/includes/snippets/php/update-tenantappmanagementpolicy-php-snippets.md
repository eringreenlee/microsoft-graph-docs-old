...
$passwordCredentials1 = new PasswordCredentialConfiguration();$passwordCredentials1->setRestrictionType('passwordAddition');
...
$passwordCredentials2 = new PasswordCredentialConfiguration();$passwordCredentials2->setRestrictionType('passwordLifetime');
...
$passwordCredentials3 = new PasswordCredentialConfiguration();$passwordCredentials3->setRestrictionType('symmetricKeyAddition');
...
$passwordCredentials4 = new PasswordCredentialConfiguration();$passwordCredentials4->setRestrictionType('customPasswordAddition');
...
$passwordCredentials5 = new PasswordCredentialConfiguration();$passwordCredentials5->setRestrictionType('symmetricKeyLifetime');
...
$keyCredentials1 = new KeyCredentialConfiguration();$keyCredentials1->setRestrictionType('asymmetricKeyLifetime');
...
$applicationRestrictions->setKeyCredentials($keyCredentialsArray);
 ...
 $graphClient->policies()->defaultAppManagementPolicy()->patch($requestRequestBody);
