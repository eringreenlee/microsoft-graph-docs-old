...
$passwordCredentials1->setRestrictionType('passwordAddition');
...
$passwordCredentials2->setRestrictionType('passwordLifetime');
...
$passwordCredentials3->setRestrictionType('symmetricKeyAddition');
...
$passwordCredentials4->setRestrictionType('customPasswordAddition');
...
$passwordCredentials5->setRestrictionType('symmetricKeyLifetime');
...
$keyCredentials1->setRestrictionType('asymmetricKeyLifetime');
