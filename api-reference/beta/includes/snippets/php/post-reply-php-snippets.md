...
$newParticipants1 = new Recipient();$newParticipants1AdditionalData = [
];
...
$attachments1 = new Attachment();$attachments1->setLastModifiedDateTime(new DateTime("2016-10-19T10:37:00Z"));
...
$post->setAttachments($attachmentsArray);
 ...
 $graphClient->groupsById("group-id")->threadsById("conversationThread-id")->postsById("post-id")->reply()->post($requestRequestBody);
