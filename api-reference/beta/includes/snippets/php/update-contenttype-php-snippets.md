...
$allowedContentTypes1 = new ContentTypeInfo();$allowedContentTypes1->setId("0x0101");
...
$defaultContents1 = new DocumentSetContent();$defaultContents1->setFileName("a.txt");
...
$defaultContents2 = new DocumentSetContent();$defaultContents2->setFileName("b.txt");
...
$sharedColumns1 = new ColumnDefinition();$sharedColumns1->setName("Description");
$sharedColumns1->setId("cbb92da4-fd46-4c7d-af6c-3128c2a5576e");

$sharedColumnsArray []= $sharedColumns1;

$sharedColumns2 = new ColumnDefinition();$sharedColumns2->setName("Address");
...
$welcomePageColumns1 = new ColumnDefinition();$welcomePageColumns1->setName("Address");
...
$documentSet->setWelcomePageColumns($welcomePageColumnsArray);
 ...
 $graphClient->sitesById("site-id")->contentTypesById("contentType-id")->patch($requestRequestBody);
