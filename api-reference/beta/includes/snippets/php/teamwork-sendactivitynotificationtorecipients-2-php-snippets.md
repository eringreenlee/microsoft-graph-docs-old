...
$requestRequestBody = new SendActivityNotificationToRecipientsRequestBody();


$topic = new TeamworkActivityTopic();
$requestRequestBody->setTopic($topic);
$topic->setSource("text");
...
$templateParameters1 = new KeyValuePair();$templateParameters1->setName("deploymentId");
...
$recipients1 = new TeamworkNotificationRecipient();$recipients1AdditionalData = [
...
$recipients2 = new TeamworkNotificationRecipient();$recipients2AdditionalData = [
"@odata.type" => "microsoft.graph.aadUserNotificationRecipient",
...
$recipients3 = new TeamworkNotificationRecipient();$recipients3AdditionalData = [
"@odata.type" => "microsoft.graph.aadUserNotificationRecipient",
...
$requestRequestBody->setRecipients($recipientsArray);
 $graphClient->teamwork()->sendActivityNotificationToRecipients()->post($requestRequestBody);
