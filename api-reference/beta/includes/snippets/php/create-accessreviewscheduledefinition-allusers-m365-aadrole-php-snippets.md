...
$backupReviewersArray = [];

$backupReviewers1 = new AccessReviewReviewerScope();$backupReviewers1AdditionalData = [
"query" => '/groups/072ac5f4-3f13-4088-ab30-0a276f3e6322/transitiveMembers',
"queryType" => 'MicrosoftGraph',
];
$backupReviewers1->setAdditionalData($backupReviewers1AdditionalData);

$backupReviewersArray []= $backupReviewers1;
$requestRequestBody->setBackupReviewers($backupReviewersArray);
