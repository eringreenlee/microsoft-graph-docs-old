...
$requestRequestBody->setDisplayName('My search 2');
$requestRequestBody->setDescription('My first search');
...
$result =  $graphClient->security()->cases()->ediscoveryCasesById('ediscoveryCase-id')->searches()->post($requestRequestBody);
