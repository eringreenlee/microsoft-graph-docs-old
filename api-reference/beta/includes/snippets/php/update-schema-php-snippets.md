...
$properties1 = new Property();$properties1->setName('ticketTitle');
...
$properties2 = new Property();$properties2->setName('priority');
...
$properties3 = new Property();$properties3->setName('assignee');
...
$requestRequestBody->setProperties($propertiesArray);
 $graphClient->external()->connectionsById('externalConnection-id')->schema()->patch($requestRequestBody);
