...
$requestRequestBody->setState('disabled');
...
$deviceStates->setIncludeStates( [
'All',],
$deviceStates->setExcludeStates( [
'Compliant',],
...
$cloudAppSecurity->setCloudAppSecurityType('blockDownloads');
