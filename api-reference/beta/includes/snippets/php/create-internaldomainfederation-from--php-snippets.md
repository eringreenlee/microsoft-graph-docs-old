...
$requestRequestBody->setPreferredAuthenticationProtocol('wsFed');
...
$requestRequestBody->setPromptLoginBehavior('nativeSupport');
...
$requestRequestBody->setFederatedIdpMfaBehavior('rejectMfaByFederatedIdp');
