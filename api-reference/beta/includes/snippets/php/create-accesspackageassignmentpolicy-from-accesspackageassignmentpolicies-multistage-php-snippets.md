...
$escalationApprovers1 = new UserSet();$escalationApprovers1->setIsBackup(True);
...
$approvalStages2 = new ApprovalStage();$approvalStages2->setApprovalStageTimeOutInDays(14);
