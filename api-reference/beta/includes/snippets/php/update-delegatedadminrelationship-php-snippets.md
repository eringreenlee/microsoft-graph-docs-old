...
$unifiedRoles1 = new UnifiedRole();$unifiedRoles1AdditionalData = [
...
$unifiedRoles2 = new UnifiedRole();$unifiedRoles2AdditionalData = [
...
$unifiedRoles3 = new UnifiedRole();$unifiedRoles3AdditionalData = [
...
$unifiedRoles4 = new UnifiedRole();$unifiedRoles4AdditionalData = [
...
$requestConfiguration->headers = $headers;
 ...
 $graphClient->tenantRelationships()->delegatedAdminRelationshipsById('delegatedAdminRelationship-id')->patch($requestRequestBody, $requestConfiguration);
